...
export default function Nav() {
  ...
  return (
    <>
      <motion.nav layout className="fixed top-4 sm:top-6 left-1/2 -translate-x-1/2 w-[95%] sm:w-[90%] max-w-5xl z-50 rounded-[24px] sm:rounded-full bg-white/80 backdrop-blur-2xl shadow-[0_16px_40px_-12px_rgba(0,0,0,0.15),_0_0_0_1px_rgba(255,255,255,0.4)_inset] px-3 sm:px-6 py-2.5 sm:py-4 flex items-center justify-between transition-all duration-300 border border-white/40">
